...
function setup({failInstall=false}={}){
  ...
  const context={URL,Request,Response,Set,caches:{open:async()=>cache,keys:async()=>['geriatrie-v280','geriatrie-v286','other-app-v1'],delete:async key=>deleted.push(key)},
