...
// Color scheme: #2563EB (cyan), #059669 (teal), #1E3A8A (dark)
...
var INTERACTIVE_FIGURES = {
  ...
  .bouchon-svg .curve-shadow {
    fill: none; stroke: #60A5FA; stroke-width: 10; stroke-linecap: round; opacity: 0.35;
  }
  .bouchon-svg .threshold-line {
    stroke: #DC2626; stroke-width: 2.5; stroke-dasharray: 8 4; opacity: 1 !important;
  }
  .bouchon-svg .zone1-area { fill: rgba(37,99,235,0.18); opacity: 1 !important; }
...
<svg class="bouchon-svg" viewBox="0 0 520 340" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;display:block;">
  ...
  <!-- Labels zones -->
  <text class="label" x="135" y="52" text-anchor="middle" font-weight="800" fill="#60A5FA" font-size="14">(1)</text>
  <text class="label" x="135" y="68" text-anchor="middle" font-size="10" fill="#60A5FA">Vieillissement</text>
  <text class="label" x="135" y="82" text-anchor="middle" font-size="10" fill="#60A5FA">physiologique</text>
  ...
  .fried-svg .axis-line { stroke: #2563EB; stroke-width: 1; opacity: 0.35; }
  ...
  .fried-svg .point-dot {
    fill: #2563EB; stroke: #fff; stroke-width: 2; r: 5;
  ...
  .fried-svg .axis-label-text:hover { fill: #2563EB; }
  ...
  .fried-svg .center-label { fill: #1E3A8A; font-size: 10px; font-weight: 700; }
...
<svg class="fried-svg" viewBox="0 0 480 420" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  ...
  <g class="crit-btn">
    ...
    <rect x="175" y="22" width="130" height="52" rx="6" fill="rgba(30,58,138,0.92)" class="crit-detail"/>
    ...
    <text x="240" y="68" text-anchor="middle" fill="#2563EB" font-size="8" class="crit-detail">↳ Clic pour fermer</text>
  </g>

  <g class="crit-btn">
    <text class="axis-label-text" x="410" y="150" text-anchor="start">Fatigue</text>
    <rect x="395" y="125" width="80" height="44" rx="6" fill="rgba(30,58,138,0.92)" class="crit-detail"/>
  ...
  <g class="crit-btn">
    ...
    <rect x="360" y="340" width="115" height="44" rx="6" fill="rgba(30,58,138,0.92)" class="crit-detail"/>
  ...
  <g class="crit-btn">
    ...
    <rect x="10" y="340" width="110" height="44" rx="6" fill="rgba(30,58,138,0.92)" class="crit-detail"/>
  ...
  <g class="crit-btn">
    ...
    <rect x="0" y="125" width="88" height="44" rx="6" fill="rgba(30,58,138,0.92)" class="crit-detail"/>
  ...
  <!-- Legend -->
  <rect x="170" y="390" width="12" height="8" rx="2" fill="rgba(37,99,235,0.18)" stroke="#2563EB" stroke-width="1"/>
  ...
  .knee-svg .bone { fill: #e8ddd3; stroke: #1E3A8A; stroke-width: 1.5; }
  ...
  .knee-svg .synovial { fill: rgba(37,99,235,0.25); stroke: #2563EB; stroke-width: 0.8; stroke-dasharray: 3 2; }
  .knee-svg .meniscus { fill: #2563EB; opacity: 0.5; }
...
<svg class="knee-svg" viewBox="0 0 440 420" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  ...
  <g class="knee-tooltip ktt-femur" style="opacity:0;transition:opacity 0.3s">
    <rect x="10" y="40" width="105" height="55" rx="6" fill="rgba(30,58,138,0.92)" stroke="#2563EB" stroke-width="1"/>
  ...
  <g class="knee-tooltip ktt-joint" style="opacity:0;transition:opacity 0.3s">
    <rect x="295" y="155" width="135" height="45" rx="6" fill="rgba(30,58,138,0.92)" stroke="#2563EB" stroke-width="1"/>
  ...
  <g class="knee-tooltip ktt-tibia" style="opacity:0;transition:opacity 0.3s">
    <rect x="295" y="250" width="135" height="55" rx="6" fill="rgba(30,58,138,0.92)" stroke="#059669" stroke-width="1"/>
  ...
  <line x1="200" y1="158" x2="210" y2="190" stroke="#2563EB" stroke-width="1.5" opacity="0.4" stroke-dasharray="4 2"/>
  <line x1="240" y1="158" x2="230" y2="190" stroke="#2563EB" stroke-width="1.5" opacity="0.4" stroke-dasharray="4 2"/>
  <text x="195" y="178" fill="#2563EB" font-size="7" text-anchor="end" class="knee-label" style="animation-delay:0.8s">LCA</text>
  <text x="245" y="178" fill="#2563EB" font-size="7" text-anchor="start" class="knee-label" style="animation-delay:0.8s">LCP</text>
</svg>`
  },
  ...
  .cog-svg .box-mci { fill: rgba(37,99,235,0.12); stroke: #2563EB; }
  .cog-svg .box-dementia { fill: rgba(239,68,68,0.10); stroke: #ef4444; }
  .cog-svg .box-risk { fill: rgba(30,58,138,0.08); stroke: #1E3A8A; stroke-width: 1.5; rx: 8; ry: 8; }
  ...
  .cog-svg .arrow-risk { stroke: #1E3A8A; stroke-width: 1.5; stroke-dasharray: 5 3; opacity: 0.5; marker-end: none; }
  .cog-svg .risk-label { fill: #1E3A8A; font-size: 8.5px; opacity: 0; animation: cog-fade 0.5s forwards; }
...
<svg class="cog-svg" viewBox="0 0 560 340" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  <defs>
    <marker id="cog-arrow" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
      <path d="M0,0 L8,3 L0,6" fill="none" stroke="#2563EB" stroke-width="1.5"/>
    </marker>
    <marker id="cog-arrow-dark" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto">
      <path d="M0,0 L8,3 L0,6" fill="none" stroke="#1E3A8A" stroke-width="1.5"/>
    </marker>
  </defs>
  ...
  <text x="180" y="155" text-anchor="middle" fill="#2563EB" font-size="8" opacity="0" style="animation:cog-fade 0.5s 1.2s forwards">~10-15%/an</text>
  <text x="380" y="155" text-anchor="middle" fill="#2563EB" font-size="8" opacity="0" style="animation:cog-fade 0.5s 2.2s forwards">~10-15%/an</text>

  <!-- Risk factor boxes (below) -->
  <g class="risk-node">
    <rect class="box box-risk" x="140" y="260" width="100" height="55"/>
    <text class="box-label" x="190" y="282" text-anchor="middle" font-size="9.5" fill="#1E3A8A">Facteurs</text>
    <text class="box-label" x="190" y="295" text-anchor="middle" font-size="9.5" fill="#1E3A8A">vasculaires</text>
    <text class="box-sub" x="190" y="308" text-anchor="middle" fill="#1E3A8A">HTA, diabète, AVC</text>
  </g>

  <g class="risk-node">
    <rect class="box box-risk" x="270" y="260" width="100" height="55"/>
    <text class="box-label" x="320" y="282" text-anchor="middle" font-size="9.5" fill="#1E3A8A">Facteurs</text>
    <text class="box-label" x="320" y="295" text-anchor="middle" font-size="9.5" fill="#1E3A8A">neurodégénératifs</text>
    <text class="box-sub" x="320" y="308" text-anchor="middle" fill="#1E3A8A">ApoE4, amyloïde</text>
  </g>

  <g class="risk-node">
    <rect class="box box-risk" x="400" y="260" width="100" height="55"/>
    <text class="box-label" x="450" y="282" text-anchor="middle" font-size="9.5" fill="#1E3A8A">Facteurs</text>
    <text class="box-label" x="450" y="295" text-anchor="middle" font-size="9.5" fill="#1E3A8A">modifiables</text>
    <text class="box-sub" x="450" y="308" text-anchor="middle" fill="#1E3A8A">Isolement, inactivité</text>
  </g>
  ...
  <line x1="100" y1="32" x2="460" y2="32" stroke="#2563EB" stroke-width="1.5" opacity="0.3"/>

  <!-- Prevalence annotations -->
  <rect x="155" y="55" width="250" height="50" rx="8" fill="rgba(37,99,235,0.06)" stroke="none"/>
  ...
  .escarre-svg .skin-layer { stroke: #1E3A8A; stroke-width: 1; }
  ...
  .escarre-svg .stage-btn.s1 { fill: rgba(37,99,235,0.12); stroke: #2563EB; }
...
<svg class="escarre-svg" viewBox="0 0 520 460" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  ...
  <line class="title-line" x1="80" y1="32" x2="440" y2="32" stroke="#2563EB" stroke-width="1.5" opacity="0.3"/>
  ...
  <g class="stage-box" id="esc-stage1" onclick="toggleEscarreStage(1)">
    ...
    <text class="stage-btn-label" x="72" y="63" text-anchor="middle" fill="#2563EB">Stade I</text>
    ...
    <g class="reveal-group" id="esc-r1">
      ...
      <!-- Layer labels -->
      <text class="skin-title" x="72" y="106" text-anchor="middle" fill="#1E3A8A">Épiderme</text>
      <text class="skin-title" x="72" y="136" text-anchor="middle" fill="#1E3A8A">Derme</text>
      ...
      <!-- Info box -->
      <g class="stage-info">
        <rect x="10" y="245" width="110" height="65" rx="6" fill="rgba(30,58,138,0.92)" stroke="#2563EB" stroke-width="1"/>
        ...
        <text x="65" y="292" text-anchor="middle" fill="#2563EB" font-size="8.5">Peau intacte</text>
        <text x="65" y="304" text-anchor="middle" fill="#2563EB" font-size="8.5">Rougeur persistante</text>
      </g>
    </g>
  </g>
  ...
  <g class="stage-box" id="esc-stage2" onclick="toggleEscarreStage(2)">
    ...
    <g class="reveal-group" id="esc-r2">
      ...
      <text class="skin-title" x="197" y="106" text-anchor="middle" fill="#1E3A8A">Épiderme</text>
      <text class="skin-title" x="197" y="136" text-anchor="middle" fill="#1E3A8A">Derme</text>
      ...
      <g class="stage-info">
        <rect x="135" y="245" width="120" height="65" rx="6" fill="rgba(30,58,138,0.92)" stroke="#059669" stroke-width="1"/>
  ...
  <g class="stage-box" id="esc-stage3" onclick="toggleEscarreStage(3)">
    ...
    <g class="reveal-group" id="esc-r3">
      ...
      <text class="skin-title" x="322" y="106" text-anchor="middle" fill="#1E3A8A">Épiderme</text>
      <text class="skin-title" x="322" y="136" text-anchor="middle" fill="#1E3A8A">Derme</text>
      ...
      <g class="stage-info">
        <rect x="260" y="245" width="125" height="65" rx="6" fill="rgba(30,58,138,0.92)" stroke="#f59e0b" stroke-width="1"/>
  ...
  <g class="stage-box" id="esc-stage4" onclick="toggleEscarreStage(4)">
    ...
    <g class="reveal-group" id="esc-r4">
      ...
      <text class="skin-title" x="447" y="106" text-anchor="middle" fill="#1E3A8A">Épiderme</text>
      <text class="skin-title" x="447" y="136" text-anchor="middle" fill="#1E3A8A">Derme</text>
      ...
      <g class="stage-info">
        <rect x="385" y="245" width="125" height="78" rx="6" fill="rgba(30,58,138,0.92)" stroke="#ef4444" stroke-width="1"/>
  ...
  <g transform="translate(15, 340)">
    ...
    <rect x="0" y="8" width="490" height="6" rx="3" fill="rgba(30,58,138,0.1)"/>
    <rect class="prog-bar" x="0" y="8" width="122" height="6" rx="3" fill="#2563EB" opacity="0.7"/>
  ...
  <g transform="translate(15, 370)">
    <rect x="0" y="0" width="490" height="80" rx="8" fill="rgba(37,99,235,0.05)" stroke="none"/>
    ...
    <text x="245" y="66" text-anchor="middle" fill="#2563EB" font-size="9" font-weight="600">Échelle de Braden : évaluation du risque</text>
  </g>
</svg>`
  },
  ...
  .ch2-svg .node-root { fill: rgba(37,99,235,0.15); stroke: #2563EB; }
...
<svg class="ch2-svg" viewBox="0 0 520 380" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  <defs><marker id="ch2-arrow" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="none" stroke="#2563EB" stroke-width="1.5"/></marker></defs>
  ...
  <g class="gnode">
    ...
    <g class="tip"><rect x="10" y="278" width="160" height="40" rx="6" fill="rgba(30,58,138,0.92)" stroke="#059669" stroke-width="1"/><text x="90" y="296" text-anchor="middle" fill="#fff" font-size="9">Prévention · Vaccination</text><text x="90" y="310" text-anchor="middle" fill="#fff" font-size="9">Activité physique · Social</text></g>
  </g>
  <!-- Branch 2: Fragile -->
  <g class="gnode">
    ...
    <g class="tip"><rect x="190" y="278" width="140" height="40" rx="6" fill="rgba(30,58,138,0.92)" stroke="#f59e0b" stroke-width="1"/><text x="260" y="296" text-anchor="middle" fill="#fff" font-size="9">Géronteambulatoire</text><text x="260" y="310" text-anchor="middle" fill="#fff" font-size="9">Rééducation · Aides</text></g>
  </g>
  <!-- Branch 3: Dépendant -->
  <g class="gnode">
    ...
    <g class="tip"><rect x="335" y="278" width="160" height="40" rx="6" fill="rgba(30,58,138,0.92)" stroke="#ef4444" stroke-width="1"/><text x="415" y="296" text-anchor="middle" fill="#fff" font-size="9">EHPAD · HAD · SSR</text><text x="415" y="310" text-anchor="middle" fill="#fff" font-size="9">Soins palliatifs · APA</text></g>
  </g>
  <!-- Legend -->
  <rect x="130" y="340" width="260" height="30" rx="6" fill="rgba(37,99,235,0.05)"/>
  ...
  .ch4-svg .ring4 { stroke: rgba(30,58,138,0.12); }
  .ch4-svg .ring3 { stroke: rgba(37,99,235,0.15); }
  .ch4-svg .ring2 { stroke: rgba(5,150,105,0.18); }
  .ch4-svg .ring1 { stroke: rgba(245,158,11,0.20); }
  .ch4-svg .center-dot { fill: #2563EB; }
...
<svg class="ch4-svg" viewBox="0 0 480 400" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  ...
  <text class="ring-label rl2" x="240" y="108" text-anchor="middle" fill="#2563EB">Justice</text>
  <text class="ring-label rl2" x="240" y="120" text-anchor="middle" fill="#2563EB" font-size="8">Équité · Accès aux soins</text>
  <text class="ring-label rl3" x="240" y="55" text-anchor="middle" fill="#1E3A8A">Cadre légal</text>
  <text class="ring-label rl3" x="240" y="67" text-anchor="middle" fill="#1E3A8A" font-size="8">Loi Kouchner · Tutelle · Curatelle</text>
  ...
  <g class="tip-box ctip-center">
    <rect x="140" y="260" width="200" height="55" rx="6" fill="rgba(30,58,138,0.92)" stroke="#2563EB" stroke-width="1"/>
    ...
    <text x="240" y="306" text-anchor="middle" fill="#2563EB" font-size="8">Directive anticipée · Personne de confiance</text>
  </g>
  <!-- Side tooltips for each ring -->
  <g class="ring-label rl4">
    <rect x="30" y="355" width="140" height="35" rx="6" fill="rgba(30,58,138,0.08)" stroke="#059669" stroke-width="1"/>
  ...
  <g class="ring-label rl4">
    <rect x="310" y="355" width="140" height="35" rx="6" fill="rgba(30,58,138,0.08)" stroke="#2563EB" stroke-width="1"/>
    <text x="380" y="372" text-anchor="middle" fill="#2563EB" font-size="8.5" font-weight="600">Secret médical partagé</text>
    <text x="380" y="384" text-anchor="middle" fill="#2563EB" font-size="7.5">Équipe de soins uniquement</text>
  </g>
</svg>`
  },
  ...
  .ch5-svg .outline { fill: none; stroke: #1E3A8A; stroke-width: 1.5; }
  ...
  .ch5-svg .fill-accent { fill: rgba(37,99,235,0.2); stroke: #2563EB; stroke-width: 1; }
...
<svg class="ch5-svg" viewBox="0 0 520 360" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  ...
  <!-- LEFT: Oreille -->
  <text class="title-text" x="130" y="50" text-anchor="middle" fill="#2563EB">OREILLE</text>
  ...
  <!-- Ossicles -->
  <circle cx="138" cy="118" r="4" fill="#2563EB" opacity="0.6"/>
  <circle cx="150" cy="115" r="3" fill="#2563EB" opacity="0.6"/>
  <circle cx="162" cy="118" r="4" fill="#2563EB" opacity="0.6"/>
  ...
  <g class="tip"><rect x="50" y="200" width="180" height="50" rx="6" fill="rgba(30,58,138,0.92)" stroke="#ef4444" stroke-width="1"/><text x="140" y="218" text-anchor="middle" fill="#fff" font-size="9" font-weight="600">Presbyacousie</text><text x="140" y="233" text-anchor="middle" fill="#fff" font-size="8.5">Perte des fréquences aiguës (4-8 kHz)</text><text x="140" y="245" text-anchor="middle" fill="#ef4444" font-size="8">Cellules ciliées → dégénérescence</text></g>
  <!-- Arrow: sound path -->
  <path d="M35,130 L80,125" stroke="#2563EB" stroke-width="1.5" fill="none" marker-end="url(#ch5-arr)"/>
  <defs><marker id="ch5-arr" markerWidth="6" markerHeight="5" refX="6" refY="2.5" orient="auto"><path d="M0,0 L6,2.5 L0,5" fill="none" stroke="#2563EB" stroke-width="1"/></marker></defs>

  <!-- Separator -->
  <line x1="260" y1="45" x2="260" y2="320" stroke="currentColor" stroke-dasharray="4 3" stroke-width="0.5" opacity="0.15"/>

  <!-- RIGHT: Œil -->
  <text class="title-text" x="390" y="50" text-anchor="middle" fill="#2563EB">ŒIL</text>
  <!-- Eye outline -->
  <ellipse class="outline" cx="390" cy="130" rx="85" ry="55"/>
  <!-- Cornea -->
  <path class="fill-accent" d="M310,130 C310,100 340,85 390,85 C440,85 470,100 470,130" fill="rgba(37,99,235,0.1)" stroke="#2563EB" stroke-width="1.5"/>
  <text class="label" x="390" y="82" text-anchor="middle" fill="#2563EB">Cornée</text>
  <!-- Lens -->
  ...
  <!-- Optic nerve -->
  <line x1="475" y1="130" x2="510" y2="130" stroke="#1E3A8A" stroke-width="2.5"/>
  <text class="label-sm" x="510" y="125" text-anchor="end" fill="#1E3A8A">Nerf</text>
  <text class="label-sm" x="510" y="137" text-anchor="end" fill="#1E3A8A">optique</text>

  <!-- Presbytie tooltip area -->
  <g class="hover-zone" style="cursor:pointer;"><rect x="370" y="105" width="40" height="50" fill="transparent"/></g>
  <g class="tip"><rect x="290" y="200" width="200" height="50" rx="6" fill="rgba(30,58,138,0.92)" stroke="#ef4444" stroke-width="1"/><text x="390" y="218" text-anchor="middle" fill="#fff" font-size="9" font-weight="600">Presbytie</text><text x="390" y="233" text-anchor="middle" fill="#fff" font-size="8.5">Perte d'élasticité du cristallín</text><text x="390" y="245" text-anchor="middle" fill="#ef4444" font-size="8">Dès 45 ans · Accommodation ↓</text></g>

  <!-- Bottom summary -->
  <rect x="60" y="280" width="400" height="60" rx="8" fill="rgba(37,99,235,0.05)"/>
  ...
  <text x="260" y="330" text-anchor="middle" fill="#2563EB" font-size="8.5">Impact : isolement, chutes, dépression, déclin cognitif</text>
</svg>`
  },
  ...
  <circle cx="175" cy="115" r="28" fill="rgba(37,99,235,0.15)" stroke="#2563EB" stroke-width="2"/>
  <path d="M195,130 L230,155 L245,220" fill="none" stroke="#2563EB" stroke-width="14" stroke-linecap="round"/>
  <!-- Greater trochanter -->
  <ellipse cx="235" cy="145" rx="16" ry="12" fill="rgba(37,99,235,0.2)" stroke="#2563EB" stroke-width="1.5"/>
  ...
  <!-- Shaft -->
  <path d="M200,55 L200,180" fill="none" stroke="#2563EB" stroke-width="16" stroke-linecap="round"/>
  <!-- Condyles -->
  <ellipse cx="175" cy="210" rx="28" ry="35" fill="rgba(37,99,235,0.15)" stroke="#2563EB" stroke-width="2"/>
  <ellipse cx="225" cy="210" rx="28" ry="35" fill="rgba(37,99,235,0.15)" stroke="#2563EB" stroke-width="2"/>
  <path d="M175,185 L225,185" stroke="#2563EB" stroke-width="10"/>
  ...
  <rect x="40" y="270" width="340" height="35" rx="8" fill="rgba(37,99,235,0.08)"/>
  ...
  <!-- Normal vertebra -->
  <rect x="50" y="70" width="70" height="50" rx="6" fill="rgba(37,99,235,0.15)" stroke="#2563EB" stroke-width="2"/>
  ...
  <rect x="40" y="230" width="360" height="70" rx="8" fill="rgba(37,99,235,0.06)"/>
  ...
  <text x="220" y="292" text-anchor="middle" fill="#2563EB" font-size="9">+ Ca²⁺ · vit. D · anti-ostéoporotique · prévention chute</text>
</svg>`
  },
  "6.5": {
  ...
  <rect x="130" y="40" width="200" height="40" rx="8" fill="rgba(37,99,235,0.15)" stroke="#2563EB" stroke-width="1.5"/>
  ...
  <path d="M230,80 L230,100" stroke="#2563EB" stroke-width="2"/>
  <rect x="130" y="100" width="200" height="40" rx="8" fill="rgba(37,99,235,0.1)" stroke="#2563EB" stroke-width="1.5"/>
  <text x="230" y="125" text-anchor="middle" fill="currentColor" font-size="11">DXA (T-score) ± radio</text>
  <path d="M230,140 L230,160" stroke="#2563EB" stroke-width="2"/>
  ...
  <path d="M230,200 L230,220" stroke="#2563EB" stroke-width="2"/>
  ...
  <rect x="60" y="290" width="340" height="60" rx="8" fill="rgba(37,99,235,0.06)"/>
  ...
  <text x="230" y="335" text-anchor="middle" fill="#2563EB" font-size="10">Algorithme clinique · pas une image TDM</text>
</svg>`
  },
  "6.6": {
  ...
  <rect x="310" y="55" width="120" height="70" rx="8" fill="rgba(37,99,235,0.12)" stroke="#2563EB" stroke-width="1.5"/>
  <text x="370" y="80" text-anchor="middle" fill="#2563EB" font-size="11" font-weight="700">FRAX élevé</text>
  ...
  <rect x="60" y="225" width="340" height="90" rx="8" fill="rgba(37,99,235,0.06)"/>
  ...
  <text x="230" y="305" text-anchor="middle" fill="#2563EB" font-size="9">Observance · effets indésirables (tableau 6.2)</text>
</svg>`
  },
  "6.7": {
  ...
  <!-- Timeline -->
  <line x1="50" y1="120" x2="410" y2="120" stroke="#2563EB" stroke-width="3"/>
  <circle cx="80" cy="120" r="12" fill="#2563EB"/>
  <circle cx="180" cy="120" r="12" fill="#2563EB"/>
  ...
  <rect x="50" y="200" width="360" height="75" rx="8" fill="rgba(37,99,235,0.07)"/>
  ...
  <text x="230" y="262" text-anchor="middle" fill="#2563EB" font-size="9">Réévaluer bénéfice / risque (rein, mâchoire, fractures atypiques)</text>
</svg>`
  },
  ...
  .ch6-svg .bone-bg { fill: #e8ddd3; stroke: #1E3A8A; stroke-width: 1.5; rx: 6; }
  ...
  .ch6-svg .arrow-down { fill: none; stroke: #2563EB; stroke-width: 2; marker-end: url(#ch6-arr);
...
<svg class="ch6-svg" viewBox="0 0 440 520" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  <defs><marker id="ch6-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="none" stroke="#2563EB" stroke-width="1.5"/></marker></defs>
  ...
  <g class="stage-box stage s1">
    ...
    <g class="tip"><rect x="100" y="105" width="240" height="30" rx="6" fill="rgba(30,58,138,0.92)" stroke="#059669" stroke-width="1"/><text x="220" y="124" text-anchor="middle" fill="#fff" font-size="9">Densité minérale osseuse normale · Trabécules denses</text></g>
  </g>
  ...
  <g class="stage-box stage s2">
    ...
    <g class="tip"><rect x="100" y="200" width="240" height="30" rx="6" fill="rgba(30,58,138,0.92)" stroke="#f59e0b" stroke-width="1"/><text x="220" y="219" text-anchor="middle" fill="#fff" font-size="9">Perte trabéculaire débutante · Vit D + Ca²⁺ + exercice</text></g>
  </g>
  ...
  <g class="stage-box stage s3">
    ...
    <g class="tip"><rect x="80" y="295" width="280" height="30" rx="6" fill="rgba(30,58,138,0.92)" stroke="#ef4444" stroke-width="1"/><text x="220" y="314" text-anchor="middle" fill="#fff" font-size="9">Trabécules amincies · Biphosphonates · Densitométrie 2 ans</text></g>
  </g>
  ...
  <g class="stage-box stage s4">
    ...
    <g class="tip"><rect x="80" y="395" width="280" height="30" rx="6" fill="rgba(30,58,138,0.92)" stroke="#ef4444" stroke-width="1"/><text x="220" y="414" text-anchor="middle" fill="#fff" font-size="9">20% mortalité à 1 an (col fémorale) · Réhabilitation précoce</text></g>
  </g>
  <!-- Stats -->
  <rect x="60" y="440" width="320" height="60" rx="8" fill="rgba(37,99,235,0.05)"/>
  ...
  <text x="220" y="488" text-anchor="middle" fill="#2563EB" font-size="8.5">Dépistage : densitométrie (DEXA) si facteurs de risque</text>
</svg>`
  },
  ...
  .ch8-svg .path-line { fill: none; stroke: #2563EB; stroke-width: 2; stroke-linecap: round; }
  .ch8-svg .signal { fill: #2563EB; r: 4; opacity: 0; }
  ...
  .ch8-svg .organ { fill: rgba(37,99,235,0.12); stroke: #2563EB; stroke-width: 1.5; rx: 8; }
...
<svg class="ch8-svg" viewBox="0 0 520 400" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  ...
  <g class="tip"><rect x="100" y="255" width="220" height="50" rx="6" fill="rgba(30,58,138,0.92)" stroke="#f59e0b" stroke-width="1"/><text x="210" y="273" text-anchor="middle" fill="#fff" font-size="9" font-weight="600">Gate Control (Melzack & Wall)</text><text x="210" y="287" text-anchor="middle" fill="#fff" font-size="8.5">Fibres Aβ (toucher) ferment la porte</text><text x="210" y="299" text-anchor="middle" fill="#f59e0b" font-size="8">→ Massage, TENS, chaleur soulagent</text></g>
  <!-- Ascending pathway -->
  ...
  <path d="M430,80 L395,110 L300,230 L250,260" fill="none" stroke="#1E3A8A" stroke-width="1.5" stroke-dasharray="5 3" opacity="0.5"/>
  <text x="350" y="260" fill="#1E3A8A" font-size="8">Modulation</text>
  <text x="350" y="272" fill="#1E3A8A" font-size="8">descendante</text>
  <!-- Legend -->
  <rect x="30" y="310" width="460" height="70" rx="8" fill="rgba(37,99,235,0.05)"/>
  ...
  <text x="260" y="360" text-anchor="middle" fill="#2563EB" font-size="8.5">Échelle EVA · EN · GDS · Douleur comportementale (ECPA)</text>
  ...
  .ch10-svg .bar2 { fill: rgba(37,99,235,0.2); stroke: #2563EB; stroke-width: 1.5; }
...
<svg class="ch10-svg" viewBox="0 0 520 340" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  ...
  <g class="seg fade-in">
    ...
    <g class="tip"><rect x="10" y="110" width="110" height="40" rx="6" fill="rgba(30,58,138,0.92)" stroke="#059669" stroke-width="1"/><text x="65" y="128" text-anchor="middle" fill="#fff" font-size="8.5">Réaction adaptative</text><text x="65" y="142" text-anchor="middle" fill="#059669" font-size="8">Transitoire · Pas de critères DSM</text></g>
  </g>
  <g class="seg fade-in">
    <rect class="spectrum-bar bar2" x="120" y="55" width="90" height="50"/>
    <text class="seg-label" x="165" y="76" text-anchor="middle" fill="#2563EB">Deuil</text>
    <text class="seg-sub" x="165" y="89" text-anchor="middle">pathologique</text>
    <g class="tip"><rect x="110" y="110" width="130" height="40" rx="6" fill="rgba(30,58,138,0.92)" stroke="#2563EB" stroke-width="1"/><text x="175" y="128" text-anchor="middle" fill="#fff" font-size="8.5">Durée > 6 mois</text><text x="175" y="142" text-anchor="middle" fill="#2563EB" font-size="8">Idéation suicidaire · Psychothérapie</text></g>
  </g>
  <g class="seg fade-in">
    ...
    <g class="tip"><rect x="210" y="110" width="140" height="40" rx="6" fill="rgba(30,58,138,0.92)" stroke="#f59e0b" stroke-width="1"/><text x="280" y="128" text-anchor="middle" fill="#fff" font-size="8.5">GDS 2-3 · Isolement</text><text x="280" y="142" text-anchor="middle" fill="#f59e0b" font-size="8">Activité sociale · Exercice · Suivi</text></g>
  </g>
  <g class="seg fade-in">
    ...
    <g class="tip"><rect x="310" y="110" width="150" height="40" rx="6" fill="rgba(30,58,138,0.92)" stroke="#ef4444" stroke-width="1"/><text x="385" y="128" text-anchor="middle" fill="#fff" font-size="8.5">GDS 4-5 · ISRS 1ère ligne</text><text x="385" y="142" text-anchor="middle" fill="#ef4444" font-size="8">Mirtazapine si insomnia/anorexie</text></g>
  </g>
  <g class="seg fade-in">
    ...
    <g class="tip"><rect x="395" y="110" width="120" height="40" rx="6" fill="rgba(30,58,138,0.92)" stroke="#ef4444" stroke-width="1"/><text x="455" y="128" text-anchor="middle" fill="#fff" font-size="8.5">Urgence psychiatrique</text><text x="455" y="142" text-anchor="middle" fill="#ef4444" font-size="8">Hospitalisation si nécessaire</text></g>
  </g>
  <!-- Severity arrow -->
  ...
  <rect x="40" y="160" width="440" height="160" rx="8" fill="rgba(37,99,235,0.05)"/>
  ...
  <text x="260" y="274" text-anchor="middle" fill="#2563EB" font-size="9">Somatisation · Troubles cognitifs réversibles ("pseudodémence")</text>
  ...
  .ch11-svg .c1 { fill: rgba(37,99,235,0.15); stroke: #2563EB; stroke-width: 2; }
  ...
  .ch11-svg .arrow { fill: none; stroke: #2563EB; stroke-width: 1.5; stroke-dasharray: 5 3; opacity: 0.5; }
...
<svg class="ch11-svg" viewBox="0 0 520 440" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  ...
  <g class="fade-in">
    ...
    <text class="label" x="140" y="65" text-anchor="middle" fill="#2563EB">(1) Début aigu</text>
  ...
  <!-- Decision node -->
  <g class="fade-in">
    <rect x="100" y="210" width="320" height="45" rx="8" fill="rgba(37,99,235,0.1)" stroke="#2563EB" stroke-width="1.5"/>
    <text class="label" x="260" y="232" text-anchor="middle" fill="#2563EB">Algorithme diagnostique</text>
  ...
  <!-- Bottom info -->
  <rect x="40" y="380" width="440" height="45" rx="8" fill="rgba(37,99,235,0.05)"/>
  ...
  <text x="260" y="415" text-anchor="middle" fill="#2563EB" font-size="8.5">Origine : Infection · Métabolique · Médicamenteuse · Sevrage</text>
</svg>`
  },
  ...
  .ch12-svg .n-intra { fill: rgba(37,99,235,0.12); stroke: #2563EB; }
  ...
  .ch12-svg .arrow-v { fill: none; stroke: #2563EB; stroke-width: 2; marker-end: url(#ch12-arr);
...
<svg class="ch12-svg" viewBox="0 0 440 520" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  <defs><marker id="ch12-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="none" stroke="#2563EB" stroke-width="1.5"/></marker></defs>
  ...
  <g class="chain-el">
    ...
    <text class="label" x="220" y="60" text-anchor="middle" fill="#2563EB">Facteurs intrinsèques</text>
  ...
  .ch14-svg .p1 { fill: rgba(37,99,235,0.20); stroke: #2563EB; }
  ...
  .ch14-svg .p5 { fill: rgba(59,130,246,0.15); stroke: #3B82F6; }
...
<svg class="ch14-svg" viewBox="0 0 480 480" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  ...
  <g class="pyra-level fade-in">
    ...
    <text class="label" x="240" y="382" text-anchor="middle" fill="#2563EB">💧 HYDRATATION</text>
    <text class="label-sm" x="240" y="398" text-anchor="middle">1.5 L/j minimum · Eau · Tisanes · Bouillon</text>
    <g class="tip"><rect x="100" y="412" width="280" height="30" rx="6" fill="rgba(30,58,138,0.92)" stroke="#2563EB" stroke-width="1"/><text x="240" y="431" text-anchor="middle" fill="#fff" font-size="9">Déshydratation = confusion, constipation, chutes · Coloration urinaire</text></g>
  </g>
  ...
  <g class="pyra-level fade-in">
    ...
    <g class="tip"><rect x="80" y="360" width="320" height="30" rx="6" fill="rgba(30,58,138,0.92)" stroke="#059669" stroke-width="1"/><text x="240" y="379" text-anchor="middle" fill="#fff" font-size="9">Prévention constipation · Microbiote · Antioxydants</text></g>
  </g>
  <!-- Level 3: Protéines -->
  <g class="pyra-level fade-in">
    ...
    <g class="tip"><rect x="80" y="300" width="320" height="30" rx="6" fill="rgba(30,58,138,0.92)" stroke="#f59e0b" stroke-width="1"/><text x="240" y="319" text-anchor="middle" fill="#fff" font-size="9">1.0-1.2 g/kg/j · Prévention sarcopénie · Collation le soir</text></g>
  </g>
  <!-- Level 4: Lipides -->
  <g class="pyra-level fade-in">
    ...
    <g class="tip"><rect x="80" y="240" width="320" height="30" rx="6" fill="rgba(30,58,138,0.92)" stroke="#ef4444" stroke-width="1"/><text x="240" y="259" text-anchor="middle" fill="#fff" font-size="9">Modération mais pas de restriction excessive · Absorption vitamines liposolubles</text></g>
  </g>
  <!-- Top: Suppléments -->
  <g class="pyra-level fade-in">
    <polygon class="pyra-shape p5" points="210,193 270,193 255,155 225,155"/>
    <text class="label" x="240" y="172" text-anchor="middle" fill="#3B82F6">Suppléments</text>
    <text class="label-sm" x="240" y="185" text-anchor="middle">Vit D · Ca²⁺</text>
    <g class="tip"><rect x="80" y="195" width="320" height="30" rx="6" fill="rgba(30,58,138,0.92)" stroke="#3B82F6" stroke-width="1"/><text x="240" y="214" text-anchor="middle" fill="#fff" font-size="9">Vit D 800-1000 UI/j · Ca 1.2g/j · B12 si carence</text></g>
  </g>
  ...
  <!-- MNA tool -->
  <rect x="100" y="440" width="280" height="30" rx="8" fill="rgba(37,99,235,0.05)"/>
  <text x="240" y="460" text-anchor="middle" fill="#2563EB" font-size="9.5" font-weight="600">Évaluation : MNA (Mini Nutritional Assessment)</text>
</svg>`
  },
  ...
  .ch15-svg .bladder { fill: rgba(37,99,235,0.15); stroke: #2563EB; }
...
<svg class="ch15-svg" viewBox="0 0 480 400" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  ...
  <text class="label" x="240" y="105" text-anchor="middle" fill="#2563EB">Vessie</text>
  ...
  <g class="fade-in">
    ...
    <g class="tip"><rect x="10" y="332" width="150" height="30" rx="6" fill="rgba(30,58,138,0.92)" stroke="#059669" stroke-width="1"/><text x="85" y="351" text-anchor="middle" fill="#fff" font-size="8.5">Remplissage → Signal → Miction</text></g>
  </g>
  <g class="fade-in">
    ...
    <g class="tip"><rect x="165" y="332" width="150" height="30" rx="6" fill="rgba(30,58,138,0.92)" stroke="#ef4444" stroke-width="1"/><text x="240" y="351" text-anchor="middle" fill="#fff" font-size="8.5">Anticholinergiques · Rééducation</text></g>
  </g>
  <g class="fade-in">
    ...
    <g class="tip"><rect x="320" y="332" width="150" height="30" rx="6" fill="rgba(30,58,138,0.92)" stroke="#f59e0b" stroke-width="1"/><text x="395" y="351" text-anchor="middle" fill="#fff" font-size="8.5">Périnée · Chirurgie · TVT</text></g>
  </g>
  <!-- Prevalence -->
  <rect x="60" y="370" width="360" height="25" rx="6" fill="rgba(37,99,235,0.05)"/>
  ...
  .ch16-svg .step1 { fill: rgba(37,99,235,0.15); stroke: #2563EB; }
  ...
  .ch16-svg .arrow { fill: none; stroke: #2563EB; stroke-width: 2; marker-end: url(#ch16-arr);
...
<svg class="ch16-svg" viewBox="0 0 440 460" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  <defs><marker id="ch16-arr" markerWidth="8" markerHeight="6" refX="8" refY="3" orient="auto"><path d="M0,0 L8,3 L0,6" fill="none" stroke="#2563EB" stroke-width="1.5"/></marker></defs>
  ...
  <g class="fade-in">
    ...
    <text class="label" x="220" y="67" text-anchor="middle" fill="#2563EB">1. Prescription</text>
  ...
  .ch17-svg .curve-degen { fill: none; stroke: #2563EB; stroke-width: 2.5; stroke-linecap: round;
...
<svg class="ch17-svg" viewBox="0 0 520 360" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  ...
  <text x="475" y="270" fill="#2563EB" font-size="9" font-weight="600">Dégénérative</text>
  <!-- Intervention points -->
...
<svg class="ch18-svg" viewBox="0 0 520 300" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  <defs><marker id="ch18-arr" markerWidth="6" markerHeight="5" refX="6" refY="2.5" orient="auto"><path d="M0,0 L6,2.5 L0,5" fill="none" stroke="#2563EB" stroke-width="1"/></marker></defs>
  ...
  <g class="fade-in">
    ...
    <text class="label" x="52" y="72" text-anchor="middle" fill="#2563EB">1</text>
  ...
  <g class="fade-in">
    ...
    <text class="label" x="322" y="72" text-anchor="middle" fill="#3B82F6">4</text>
  ...
  <rect x="15" y="130" width="490" height="150" rx="8" fill="rgba(37,99,235,0.04)"/>
  ...
  <text x="260" y="224" text-anchor="middle" fill="#2563EB" font-size="9" font-weight="600">Objectif : reproduire la démarche clinique réelle</text>
  ...
  .ch19-svg .center-circle { fill: rgba(37,99,235,0.15); stroke: #2563EB; stroke-width: 2.5; }
  .ch19-svg .branch-line { stroke: #2563EB; stroke-width: 1.5; fill: none; stroke-dasharray: 80; stroke-dashoffset: 80; }
  ...
  .ch19-svg .l1 { fill: rgba(37,99,235,0.12); stroke: #2563EB; }
...
<svg class="ch19-svg" viewBox="0 0 480 380" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  ...
  <text x="240" y="172" text-anchor="middle" fill="#2563EB" font-size="10" font-weight="700">Problème</text>
  <text x="240" y="186" text-anchor="middle" fill="#2563EB" font-size="10" font-weight="700">clinique</text>
  <!-- Branch 1: Données -->
  <line class="branch-line b1" x1="200" y1="150" x2="100" y2="80"/>
  <g class="fade-in">
    <rect class="leaf l1" x="20" y="50" width="140" height="55"/>
    <text class="leaf-label" x="90" y="70" text-anchor="middle" fill="#2563EB">Données</text>
  ...
  <!-- Bottom -->
  <rect x="60" y="345" width="360" height="25" rx="6" fill="rgba(37,99,235,0.05)"/>
  <text x="240" y="362" text-anchor="middle" fill="#2563EB" font-size="9" font-weight="600">Key Features Problems : raisonnement clinique structuré</text>
</svg>`
  },
  ...
  .ch20-svg .c1 { fill: rgba(37,99,235,0.12); stroke: #2563EB; }
  ...
  .ch20-svg .c5 { fill: rgba(59,130,246,0.12); stroke: #3B82F6; }
  .ch20-svg .c6 { fill: rgba(30,58,138,0.12); stroke: #1E3A8A; }
  ...
  .ch20-svg .cc1 { fill: #2563EB; animation-delay: 0.3s; }
  ...
  .ch20-svg .cc5 { fill: #3B82F6; animation-delay: 1.5s; }
  .ch20-svg .cc6 { fill: #1E3A8A; animation-delay: 1.8s; }
...
<svg class="ch20-svg" viewBox="0 0 480 320" xmlns="http://www.w3.org/2000/svg" style="max-width:100%;height:auto;">
  ...
  <g><rect class="card c1" x="20" y="45" width="135" height="80"/>
    ...
    <text class="card-label" x="87" y="100" text-anchor="middle" fill="#2563EB">Urgences</text>
    <text class="card-label" x="87" y="115" text-anchor="middle" font-size="7" opacity="0.6">Chute · Confusion · Douleur</text>
    <g class="tip"><rect x="10" y="128" width="155" height="25" rx="6" fill="rgba(30,58,138,0.92)" stroke="#2563EB" stroke-width="1"/><text x="87" y="145" text-anchor="middle" fill="#fff" font-size="8">ITEM 109, 131, 108, 130</text></g>
  </g>
  <g><rect class="card c2" x="172" y="45" width="135" height="80"/>
    ...
    <g class="tip"><rect x="162" y="128" width="155" height="25" rx="6" fill="rgba(30,58,138,0.92)" stroke="#059669" stroke-width="1"/><text x="239" y="145" text-anchor="middle" fill="#fff" font-size="8">ITEM 322, 325, 128</text></g>
  </g>
  <g><rect class="card c3" x="325" y="45" width="135" height="80"/>
    ...
    <g class="tip"><rect x="315" y="128" width="155" height="25" rx="6" fill="rgba(30,58,138,0.92)" stroke="#f59e0b" stroke-width="1"/><text x="392" y="145" text-anchor="middle" fill="#fff" font-size="8">ITEM 322, 325</text></g>
  </g>
  <g><rect class="card c4" x="20" y="150" width="135" height="80"/>
    ...
    <g class="tip"><rect x="10" y="233" width="155" height="25" rx="6" fill="rgba(30,58,138,0.92)" stroke="#ef4444" stroke-width="1"/><text x="87" y="250" text-anchor="middle" fill="#fff" font-size="8">ITEM 9, 139</text></g>
  </g>
  <g><rect class="card c5" x="172" y="150" width="135" height="80"/>
    <text class="card-count cc5" x="239" y="185" text-anchor="middle">8</text>
    <text class="card-label" x="239" y="205" text-anchor="middle" fill="#3B82F6">Gériatrie générale</text>
    <text class="card-label" x="239" y="220" text-anchor="middle" font-size="7" opacity="0.6">Vieillissement · Fragilité</text>
    <g class="tip"><rect x="162" y="233" width="155" height="25" rx="6" fill="rgba(30,58,138,0.92)" stroke="#3B82F6" stroke-width="1"/><text x="239" y="250" text-anchor="middle" fill="#fff" font-size="8">ITEM 123, 121, 230</text></g>
  </g>
  <g><rect class="card c6" x="325" y="150" width="135" height="80"/>
    <text class="card-count cc6" x="392" y="185" text-anchor="middle">5</text>
    <text class="card-label" x="392" y="205" text-anchor="middle" fill="#1E3A8A">Neurologie</text>
    <text class="card-label" x="392" y="220" text-anchor="middle" font-size="7" opacity="0.6">Démence · AVC · Parkinson</text>
    <g class="tip"><rect x="315" y="233" width="155" height="25" rx="6" fill="rgba(30,58,138,0.92)" stroke="#1E3A8A" stroke-width="1"/><text x="392" y="250" text-anchor="middle" fill="#fff" font-size="8">ITEM 23, 108</text></g>
  </g>
  <!-- Total -->
  <rect x="120" y="260" width="240" height="40" rx="8" fill="rgba(37,99,235,0.08)"/>
  <text x="240" y="280" text-anchor="middle" fill="currentColor" font-size="10" font-weight="600">31 questions isolées au total</text>
  <text x="240" y="295" text-anchor="middle" fill="#2563EB" font-size="8.5">Chaque question = 1 scenario clinique court</text>
</svg>`
  }
...
INTERACTIVE_FIGURES['1.1'] = {
  ...
  svg: `<style>
    ...
    .bouchon-exact .recovery{fill:none;stroke:#2563EB;stroke-width:3;stroke-dasharray:6 5;marker-end:url(#bouchon-up)}
  ...
  <svg class="bouchon-exact" viewBox="0 0 680 390" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="bouchon-title bouchon-desc">
    ...
    <defs><marker id="bouchon-up" markerWidth="8" markerHeight="8" refX="7" refY="4" orient="auto"><path d="M0 0L8 4L0 8Z" fill="#2563EB"/></marker></defs>
    ...
    <path class="recovery" d="M414 292 C438 272 449 247 461 226"/><text x="471" y="244" fill="#2563EB" font-size="11" font-weight="750">Effet de l’intervention</text>
    ...
    <g transform="translate(92 292)"><rect width="270" height="31" rx="15" fill="rgba(37,99,235,.10)"/><text x="135" y="20" text-anchor="middle" fill="currentColor" font-size="11" font-weight="700">Réserve fonctionnelle encore mobilisable</text></g>
  </svg>`
};
...
INTERACTIVE_FIGURES['7.2'] = {
  ...
  svg: `<style>
    ...
    .cox-svg .bone{fill:rgba(37,99,235,.10);stroke:currentColor;stroke-width:3}
    .cox-svg .dense{fill:none;stroke:#2563EB;stroke-width:12;stroke-linecap:round}
  ...
  <svg class="cox-svg" viewBox="0 0 680 430" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="cox-title cox-desc">
    ...
    <g><line class="leader" x1="226" y1="125" x2="492" y2="68"/><text class="call" x="500" y="58">B · Ostéocondensation</text><text x="500" y="75" fill="#2563EB" font-size="11">os sous-chondral</text></g>
    ...
    <g fill="#1E3A8A" font-size="10" font-weight="850">
      <circle cx="166" cy="188" r="12" fill="#fff" stroke="#1E3A8A"/><text x="166" y="192" text-anchor="middle">1</text>
      <circle cx="194" cy="235" r="12" fill="#fff" stroke="#1E3A8A"/><text x="194" y="239" text-anchor="middle">2</text>
      <circle cx="250" cy="281" r="12" fill="#fff" stroke="#1E3A8A"/><text x="250" y="285" text-anchor="middle">3</text>
      <circle cx="326" cy="263" r="12" fill="#fff" stroke="#1E3A8A"/><text x="326" y="267" text-anchor="middle">4</text>
      <circle cx="365" cy="223" r="12" fill="#fff" stroke="#1E3A8A"/><text x="365" y="227" text-anchor="middle">5</text>
      <circle cx="347" cy="151" r="12" fill="#fff" stroke="#1E3A8A"/><text x="347" y="155" text-anchor="middle">6</text>
    </g>
