const ANNALES = [
  ...
  { id: 10, chapter: 'ch17', difficulty: 'A',
    ...
    questions: [
      { q: "Qu'est-ce que la sédation en fin de vie ?", a: "Administration de médicaments à doses progressives pour obtenir une diminution de la vigilance visant à soulager une souffrance réfractaire. Types : sédation proportionnelle (réversible), sédation profonde et continue jusqu'au décès (SPCMD). Conditions : souffrance réfractaire (traitée sans résultat), demande du patient ou de la personne de confiance, décision collégiale, traçature.", rang: "A" },
      { q: "Quelles sont les conditions légales de la sédation ?", a: "Loi Claeys-Leonetti (2016) : 1. Souffrance réfractaire à tous les traitements. 2. Situation en phase avancée ou terminale. 3. Demande du patient (ou directive anticipée/personne de confiance). 4. Décision collégiale (médecin + 2 confrères). 5. Information du patient et de l'entourage. 6. Traçature dans le dossier. La sédation peut être intermittente, proportionnelle ou profonde et continue.", rang: "A" },
